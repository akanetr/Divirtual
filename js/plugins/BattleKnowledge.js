...
Imported['BattleKnowledge'] = 1.02;

/*:
 * @plugindesc ver1.02/ダメージに補正を与える色々な機能を追加します。
 * @author Yana
 * 
 * @help------------------------------------------------------
 *  プラグインコマンドはありません。
			...
			if (k){
				...
				default:
					if ($dataSystem.weaponTypes.contains(type)){
						...
						flag = subject.isWtypeEquipped(id) && item.hitType === Game_Action.HITTYPE_PHYSICAL;
